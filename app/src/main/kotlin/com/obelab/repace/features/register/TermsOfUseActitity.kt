...
import kotlinx.android.synthetic.main.activity_terms_of_use.webView
import kotlinx.android.synthetic.main.header_back.*

class TermsOfUseActitity : BaseActivity() {

    companion object {
        fun callingIntent(context: Context) = Intent(context, TermsOfUseActitity::class.java)
    }
    ...
    private fun setUpView() {
        tvTitle.text = getText(R.string.title_terms_of_use)
...
//            tvTermsOfUse.setText(Html.fromHtml(commonCodeModel.value))
