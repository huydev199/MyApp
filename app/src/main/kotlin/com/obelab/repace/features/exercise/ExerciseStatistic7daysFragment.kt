...
class ExerciseStatistic7daysFragment  : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Functions.showLog("Pass intent 7: ${mAcitive.query.type}, ${mAcitive.query.activity}")
        super.onViewCreated(view, savedInstanceState)
        with(viewModel){
            observe(resExerciseLast7DaysResultModel, ::renderExercise)
            failure(failure, ::handleFailure)
        }
        viewModel.getExercise7days(mAcitive.query)
        setupFragment()
    }
...
//        xAxis.labelRotationAngle = +90f
    ...
    inner class MyAxisFormatter : IndexAxisValueFormatter() {
        override fun getAxisLabel(value: Float, axis: AxisBase?): String {
            ...
            return if (index < speed.size) {
                Functions.simpleDatetoMD( speed[index].date.toString())
            } else {
                ""
            }
        }
    ...
    private fun setDataToBarChart(flag : Int) {
        ...
        for (i in speed.indices) {
            val score = speed[i]
            Functions.showLog("score off speed: ${score}, ${i}")
            when(flag){
                SPEED_SELECT -> {
...
//        val data = LineData(lineDataSet)
        ...
        dataset.barWidth = 0.4f // set custom bar width
        barChart.invalidate()
//        barChart.setData(dataset)
    ...
    private fun setupFragment(){
        btnSpeed.setOnClickListener {
            btnSpeed.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorTextPrimary))
            btnDistance.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
            btnTime.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
            btnSmo2.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
        ...
        btnDistance.setOnClickListener {
            btnSpeed.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
            btnDistance.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorTextPrimary))
            btnTime.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
            btnSmo2.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
        ...
        btnTime.setOnClickListener {
            btnSpeed.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
            btnDistance.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
            btnTime.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorTextPrimary))
            btnSmo2.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
            btnSpeed.setBackgroundResource(R.drawable.btn_disable)
            btnDistance.setBackgroundResource(R.drawable.btn_disable)
        ...
        btnSmo2.setOnClickListener {
            ...
            btnDistance.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
            btnTime.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorText))
            btnSmo2.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorTextPrimary))
            btnSpeed.setBackgroundResource(R.drawable.btn_disable)
            btnDistance.setBackgroundResource(R.drawable.btn_disable)
            btnTime.setBackgroundResource(R.drawable.btn_disable)
