 ...
 */
package com.obelab.repace.core.di

import com.obelab.repace.BuildConfig
import com.obelab.repace.DBManager.PrefManager
import com.obelab.repace.features.movies.MoviesRepository
...
class ApplicationModule {
    ...
    private fun createClient(): OkHttpClient {
        ...
        okHttpClientBuilder.addInterceptor(Interceptor { chain ->
            val request: Request =
                chain.request().newBuilder().addHeader("Authorization", "Bearer "+PrefManager.getToken()).build()
    ...
    @Provides
    @Singleton
    fun provideAppRepository(dataSource: AppRepository.Network): AppRepository = dataSource
}
