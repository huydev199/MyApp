...
import com.obelab.repace.model.Stage

class LtTestHistoryDetailAdapter(var listPerformance: List<Stage>) :
    RecyclerView.Adapter<LtTestHistoryDetailAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): LtTestHistoryDetailAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.row_lt_test_history_detail, parent, false)
        return ViewHolder(v)
    }

    override fun onBindViewHolder(holder: LtTestHistoryDetailAdapter.ViewHolder, position: Int) {
