...
@Inject constructor(private val repository: AppRepository) : UseCase<ResBaseModel, RequestSocialConnectModel>() {
    override suspend fun run(param: RequestSocialConnectModel) = repository.socialConnectRequest(param)
